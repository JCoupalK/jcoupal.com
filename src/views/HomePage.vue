<template>
  <div class="home-container">
    ...
    <p>I'm a Lead DevSecOps Engineer, Co-Founder of KeepSec and Vullify, and an Open Source contributor.</p>
    <p>I specialize in building tools and solutions across cloud computing, cybersecurity, and data integration.</p>
    <h2>My Skills</h2>
...
export default {
  ...
  data() {
    return {
      skills: ['Linux', 'Automation', 'Go', 'Python', 'SQL', 'JS', 'Kubernetes', 'OpenStack', 'Networking', 'Cybersecurity', 'API Design', 'CI/CD'],
    };
  },
};
</script>
